...
| `format` | both | analyze: `json,sarif,html,md,csv,docx-comments,checklist-md,checklist-csv,dates-md,dates-ics,obligations-csv,deadlines-ics,posture-md,posture-csv,posture-sheet,definitions-csv` (default `sarif`) · compare: `json\|markdown` |
