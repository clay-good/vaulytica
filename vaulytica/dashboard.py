"""
Vaulytica Web Dashboard - Interactive UI for security event analysis.

This module provides a modern web-based dashboard for:
- Real-time event monitoring
- ML-powered threat visualization
