...
`1,062 deterministic rules` · `16 document sub-domains` · `35 state-law overlays` · `0 servers` · `0 AI` · `2,507 passing tests` · `v6.0.0` · `MIT`
...
npm run lint         # eslint
npm run test         # vitest — 2,507 tests, ~10s
