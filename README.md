...
`1,065 deterministic rules` · `20 cross-document checks` · `5 pre-disclosure checks` · `3 execution-readiness reconciliations` · `5 derived-deadline families` · `16 document sub-domains` · `77 state-law overlays (non-compete · security deposit · usury · will formalities)` · `10 export formats` · `0 servers` · `0 AI` · `4,244 passing tests` · `v9.41.0` · `MIT`
...
# assert the will's state: with a verified formalities overlay (40 verified states) the recital
...
npm run lint         # eslint
npm run test         # vitest — 4,244 tests, ~30s
