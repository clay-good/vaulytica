...
`1,062 deterministic rules` · `20 cross-document checks` · `16 document sub-domains` · `35 state-law overlays` · `7 export formats` · `0 servers` · `0 AI` · `2,692 passing tests` · `v8.0.0` · `MIT`
...
npm run lint         # eslint
npm run test         # vitest — 2,692 tests, ~20s
