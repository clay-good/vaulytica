...
`1,065 deterministic rules` · `20 cross-document checks` · `5 pre-disclosure checks` · `3 execution-readiness reconciliations` · `5 derived-deadline families` · `16 document sub-domains` · `37 state-law overlays (non-compete · security deposit · usury)` · `10 export formats` · `0 servers` · `0 AI` · `4,130 passing tests` · `v9.41.0` · `MIT`
...
npm run lint         # eslint
npm run test         # vitest — 4,130 tests, ~30s
