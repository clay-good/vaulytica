...
const NY_CONVENTION_PARTIES = /\b(?:United\s+States|Canada|Mexico|United\s+Kingdom|Germany|France|Japan|Australia|Singapore|Hong\s+Kong|China|India|Brazil|Spain|Italy|Netherlands|Switzerland|South\s+Korea|Sweden|Ireland|Israel|UAE|Norway|Belgium|Austria|Denmark|Finland|Portugal|Poland|England\s+and\s+Wales)\b/i;
...
export const rule: Rule = {
  ...
  check(ctx: RuleContext): Finding | null {
    ...
    if (/\b(?:state|federal|United\s+States|Delaware|New\s+York|California|Texas|Florida|Illinois|Massachusetts|Washington|Georgia|Pennsylvania|D\.?C\.?)\b/i.test(venue.raw_text)) return null;
