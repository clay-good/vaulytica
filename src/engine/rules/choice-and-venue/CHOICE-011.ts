...
export const rule: Rule = {
  ...
  check(ctx: RuleContext): Finding | null {
    ...
    return emit(ctx, rule, {
      ...
      explanation:
        "Cal. Lab. Code § 925 makes an out-of-state choice-of-law or forum provision voidable by the employee (not void) in employment contracts entered into, modified, or extended after Jan. 1, 2017. It applies to employees who primarily reside and work in California and were required to agree as a condition of employment, and not where the employee was individually represented by counsel in negotiating the venue or choice-of-law terms. Cal. Bus. & Prof. Code § 16600.5 (2024) extends similar reasoning to non-competes: they are unenforceable regardless of where signed if the worker is in California, and create a private right of action with attorneys' fees. This pattern is commonly used to evade California's strict non-compete prohibitions; courts (e.g., Lyon v. Neustar) routinely refuse to enforce it.",
      recommendation:
