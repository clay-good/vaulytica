...
export const rule: Rule = {
  ...
  check(ctx: RuleContext): Finding | null {
    ...
    return emit(ctx, rule, {
      ...
      excerpt: hit.match[0],
      explanation:
        "Typical auto-renewal notice windows are 30 to 90 days. Anything outside that band — too long and the customer is likely to forget, too short and they are likely to miss it — warrants review. " +
        AUTO_RENEWAL_LAW,
      recommendation:
