...
const COMPLIANT_SCC2: [string, ...string[]][] = [
  [
    "EU SCCs Module 2",
    "Effective Date: January 1, 2026. The parties agree to incorporate the EU Standard Contractual Clauses.",
  ],
  ["Clause 1 — Purpose and Scope", "These Clauses ensure compliance with Article 46(1) GDPR."],
  [
    "Clause 2 — Effect and Invariability",
    "The Parties undertake not to modify the Clauses, except to select the appropriate Module(s) or to add other clauses that do not contradict.",
  ],
  [
  ...
  [
    ...
    "The data importer shall have the data exporter's prior specific or general written authorisation for engaging Sub-processors. Annex III lists the current Sub-processors.",
  ],
  [
    "Clause 11 — Redress",
    "The data importer shall inform data subjects in a transparent manner of the redress mechanisms.",
  ],
  [
    "Clause 14 — Local laws",
    "The Parties have conducted a Transfer Impact Assessment of local laws and practices.",
  ],
  [
    "Clause 15 — Public Authority Access",
    "The data importer shall notify the data exporter promptly of any legally-binding request from a public authority and challenge such request where permitted.",
  ],
  [
  ...
  [
    "Clause 18 — Governing Law and Forum",
    "These Clauses shall be governed by the law of an EU Member State allowing third-party-beneficiary rights, namely Ireland.",
  ],
...
const COMPLIANT_UK_ADDENDUM: [string, ...string[]][] = [
  ...
  [
    ...
    "Either party may end this Addendum on a revision.",
  ],
  [
    "TIA",
    "A Transfer Risk Assessment has been completed pursuant to local laws and practices analysis.",
  ],
];
...
describe("Transfer ruleset — registry contract", () => {
  ...
  it("does not run when no transfer playbook is active", async () => {
    const ctx = buildContext([
      "Agreement",
      "Generic services agreement with personal data references.",
    ]);
