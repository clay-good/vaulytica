  ...
  check(ctx: RuleContext): Finding | null {
    ...
    if (
      firstParagraphMatch(
        ...
        // The other national comprehensive laws are named the same way: an
        // Australian services agreement that binds the supplier to "the
        // Privacy Act 1988 (Cth) and the Australian Privacy Principles" was
        // told it cites no data regime. New Zealand (Privacy Act 2020), Canada
        // (PIPEDA spelled out), South Africa (POPIA), Singapore and Malaysia
        // (PDPA), Japan (APPI), India (DPDP Act) and China (PIPL spelled out)
