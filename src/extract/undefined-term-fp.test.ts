...
const SHOULD_NOT_FLAG: Array<[phrase: string, sentence: string]> = [
  ["Securities and Exchange Commission", "The Company files with the Securities and Exchange Commission. The Securities and Exchange Commission reviews it."],
  ["Internal Revenue Service", "Notice goes to the Internal Revenue Service. The Internal Revenue Service responds."],
  ["Board of Directors", "The Board of Directors approves. The Board of Directors meets quarterly."],
  ...
  ["New York Stock Exchange", "Shares list on the New York Stock Exchange. The New York Stock Exchange approves listings."],
...
describe("STRUCT-006 undefined-term FP guard", () => {
  ...
  it("positive control: an invented Title-Case term used twice IS flagged", () => {
    const flagged = extractDefinitions(
      buildTree(["Body", "The Frobnicator Widget ships today. Each Frobnicator Widget is inspected."]),
